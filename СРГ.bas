...
Sub GetData()
    ...
    'N1 = rngAll.Columns.Count 'подумать над авто диапазоном
...
Sub Main()
    ...
    Names_Array = Array("Лист_2", "Лист_3", "Лист_4", "Лист_5", "Лист_6", "Лист_7", "Лист_8")
    ...
    Names_Array = Array("Лист_2", "Лист_3", "Лист_4")
    ...
    For i = LBound(Names_Array) To UBound(Names_Array)
            ...
            Select Case shtX.Name
                ...
                str_Crit_2 = ">1" 'ПОМЕНЯЛ С ЕДИНИЦЫ
                Field_1 = 8
                Field_2 = 34
                str_Crit_3 = "Нарушение срока регистрации"
                ...
                Field_1 = 30
                Field_2 = 35
                str_Crit_3 = "Нарушение срока отправки"
            ...
            Select Case Calc
                ...
                With shtX
                    ...
                    .Range("B6").FormulaLocal = "=ВПР($A6;'>>DATA'!$A:$AL;2;0)"
                    .Range("C6").FormulaLocal = "=ВПР($A6;'>>DATA'!$A:$AL;9;0)"
                    .Range("D6").FormulaLocal = "=ВПР($A6;'>>DATA'!$A:$AL;10;0)"
                    .Range("E6").FormulaLocal = "=ВПР($A6;'>>DATA'!$A:$AL;25;0)"
                    .Range("F6").FormulaLocal = _
                    "=ЕСЛИ(ВПР($A6;'>>DATA'!$A:$AL;26;0)="""";""НЕ УСТАНОВЛЕН"";ВПР($A6;'>>DATA'!$A:$AL;26;0))"
                    .Range("G6").FormulaLocal = "=ВПР($A6;'>>DATA'!$A:$AL;14;0)"
                    .Range("H6").FormulaLocal = "=ВПР($A6;'>>DATA'!$A:$AL;33;0)"
  
                End With
                
                If shtX.Name <> "Лист_4" Then
                    shtX.Range("I6").Value = str_Crit_3
                    Else: shtX.Range("I6").FormulaLocal = "=ВПР($A6;'>>DATA'!$A:$AL;27;0)"
                End If
    ...
    Names_Array = Array("Лист_5", "Лист_6", "Лист_7", "Лист_8")
    ...
    For i = LBound(Names_Array) To UBound(Names_Array)
            ...
            Select Case shtX.Name
                ...
                str_Crit_1 = "1 день до истечения срока продления"
               
                Case "Лист_6"
                
                str_Crit_1 = "Требуется доп. ответ"
                
                Case "Лист_7"
                
                str_Crit_1 = "Обращения Департаментов ЦБ РФ"
                
                Case "Лист_8"
                
                str_Crit_1 = "Предписания ЦБ РФ в работе"
    ...
    strAdress = _
"\\hq.rgs.ru\users\RGS\Департамент взаимодействия с регуляторами\05_Методология и анализ\Отчетность\Отчеты 2019\ЦБ\Статусы\" & strX & "Статус работы групп (ЦБ РФ).pdf"
...
End Sub
   ...
   Select Case Question
        ...
        Case vbYes
            ...
            sSubject = "Статус работы групп на " & strX
            
            sBody = "<p>Добрый день, Коллеги!</p>" & _
                    "Направляю отчет ""Статус работы групп"" по состоянию на сегодня (за предыдущий рабочий день).<br>"
              
            strAdress = _
            "\\hq.rgs.ru\users\RGS\Департамент взаимодействия с регуляторами\05_Методология и анализ\Отчетность\Отчеты 2019\ЦБ\Статусы\" & "!" & strX & "_" & "Статус работы групп (ЦБ РФ).pdf"
